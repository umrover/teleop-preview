    ...
    >
      ...
      <div class="flex justify-between items-center">
        ...
        <div class="flex gap-1">
          <button class="btn btn-sm btn-warning btn-icon" @click="autonomyStore.unstageOne(wp)"><i class="bi bi-box-arrow-left"></i></button>
          <button class="btn btn-sm btn-danger btn-icon" @click="autonomyStore.removeFromExecution(wp)"><i class="bi bi-trash-fill"></i></button>
        </div>
      </div>
    </div>
  </div>
